    ...
    <Bank name="PicPay" padding="pt-3" img="/pp.png" owner="RODRIGO DE BRITO" account={[91011, 11109]} />*/}
                        ...
                        </div>
                        {
                            nubank ? <div className=" text-left pl-20 bg-gray-700 text-white border-b-2">
                                ...
                                <div className=" h-full">
                                    ...
                                    <button className="bg-green-600 text-gray-100 p-2 my-1 rounded-md shadow-xl"><a href="https://wa.me/55869182264086?text=oi!!!">Enviar comprovante</a></button>
                        ...
                        }
                        {
                            picpay ? <div className="text-left bg-gray-700 text-white">
                                <p className="font-bold">Nos envie o comprovante:</p>                                        <div className=" h-full">
                                    <button className="bg-green-600 text-gray-100 p-2 mt-1 rounded-md shadow-xl"><a href="https://wa.me/55869182264086?text=oi!!!">Enviar comprovante</a></button>
                                </div>
